...
public class PlaceApiConnectionTest {
    ...
    public PlaceApiConnectionTest(GlobalClass context, boolean details) {
        PlaceApiConnectionTest.context = context;
    ...
    public static void getPlaces(String place, final PlaceApiCallBack placeApiCallBack) {
        ...
        retrofitPlaceApiEndpoints.getPlaces(place, KEY_API, language, country).enqueue(new Callback<PlaceAPiModel>() {
            @Override
