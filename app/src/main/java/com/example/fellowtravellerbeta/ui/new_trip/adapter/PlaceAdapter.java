package com.example.fellowtravellerbeta.ui.new_trip.adapter;
...
public class PlaceAdapter extends RecyclerView.Adapter<PlaceAdapter.ExampleViewHolder> {
    ...
    private ArrayList<PredictionResponse> mExampleList;
    ...
    public PlaceAdapter(ArrayList<PredictionResponse> exampleList) {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        PredictionResponse currentItem = mExampleList.get(position);
